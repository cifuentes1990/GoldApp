...
mongoose
  .connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/giorgio_trading')
  .then(async () => {
...
async function seedDatabase() {
  ...
  if (!adminExists) {
    ...
    console.log('✅ Admin user created → admin@giorgio.com / Admin1234!');
  }
